...
func TestOpenAIProvider_ToolCallParsing_NonStreaming(t *testing.T) {
	...
	result, err := p.Execute(context.Background(), Request{Prompt: "read /etc/hosts"})
	if err != nil {
...
func TestOpenAIProvider_MultiTurnMessages(t *testing.T) {
	...
	result, err := p.ExecuteWithTools(context.Background(), Request{
...
func TestOpenAIProvider_MultipleToolResults(t *testing.T) {
	...
	_, err := p.ExecuteWithTools(context.Background(), Request{
		Prompt: "read both",
		Messages: []Message{
			{Role: "assistant", Content: assistantContent},
			{Role: "user", Content: userContent},
...
func TestOpenAIProvider_StreamingToolCalls(t *testing.T) {
	...
	result, err := p.Execute(context.Background(), Request{
		Prompt:  "list files",
		OnEvent: func(e Event) { eventCh <- e },
	})
	if err != nil {
		t.Fatalf("Execute error: %v", err)
	}
...
func TestOpenAIProvider_NoToolsNoToolsInRequest(t *testing.T) {
	...
	_, err := p.Execute(context.Background(), Request{Prompt: "hi"})
	if err != nil {
		t.Fatalf("error: %v", err)
	}
...
func TestOpenAIProvider_HTTPError(t *testing.T) {
	...
	result, err := p.Execute(context.Background(), Request{Prompt: "hello"})
	if err != nil {
